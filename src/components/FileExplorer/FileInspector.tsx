...
import { X, File as FileIcon, Info, Image as ImageIcon, Video, Music, Link as LinkIcon, Trash2, Send, Edit, Move, CheckCircle2, Download } from 'lucide-react';
...
export function FileInspector({ file, onClose }: FileInspectorProps) {
  ...
  const handleDownload = () => {
    if (!file) return;
    const href = `${window.location.origin}/api/files/${file.id}/download`;
          ...
          <div className="flex-1 p-4 space-y-6 overflow-y-auto">
            ...
            <Card className="shadow-md">
              ...
              <CardContent className="grid grid-cols-2 gap-2">
                ...
                <Button variant="outline" className="col-span-2" onClick={handleDownload}><Download className="mr-2 h-4 w-4" /> Download</Button>
